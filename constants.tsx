...
export const HERO_CONTENT = {
  ...
  description:
    "4 years of experience building scalable web, mobile, and software systems using React.js, Next.js, Node.js, Django, and PostgreSQL. Specialized in creating high-performance, user-centered products with clean architecture.",
};
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "A modern social media platform focusing on privacy and community building.",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description:
      "Developed and maintained modern web applications using React.js, Next.js, and PostgreSQL. Integrated Cloudinary for media management and REST APIs. Implemented JWT authentication and collaborated with UI/UX designers.",
  ...
  },
  {
    ...
    description:
      "Contributed to multiple full-stack projects using React.js, Node.js, and Express. Learned and implemented Docker, Redux Toolkit, and MUI. Assisted in API design and database schema creation.",
  ...
  },
  {
    ...
    period: "5th Semester",
    description:
      "Coursework focused on Web Development, Database Design, Algorithms, AI Fundamentals, and Software Engineering.",
